...
public class VietnameseTokenizer extends Tokenizer {
    public static final boolean DEFAULT_SENTENCE_DETECTOR_ENABLED = true;
    public static final boolean DEFAULT_AMBIGUITIES_RESOLVED = false;
    ...
    public VietnameseTokenizer() {
        this(DEFAULT_SENTENCE_DETECTOR_ENABLED, DEFAULT_AMBIGUITIES_RESOLVED);
    }
    ...
    public VietnameseTokenizer(boolean sentenceDetectorEnabled, boolean ambiguitiesResolved) {
        ...
        tokenizer = getTokenizer(ambiguitiesResolved);
    }

    private vn.hus.nlp.tokenizer.Tokenizer getTokenizer(boolean ambiguitiesResolved) {
        return AccessController.doPrivileged((PrivilegedAction<vn.hus.nlp.tokenizer.Tokenizer>) () -> {
